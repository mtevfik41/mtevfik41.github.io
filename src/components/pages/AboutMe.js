  ...
  return (
      <div className="main-home">
        ...
        <div className="about-me-section">
          <h1 className="about-me-section-header">About me: Mustafa Tevfik
            Kadan</h1>
          <hr/>
          <p className="about-paragraph">
            ...
            School by staying in a dormitory.I graduated from high school with
            an average of 3.52/4.
          </p>
          <p className="about-paragraph">
          ...
          <p className="about-paragraph">
            ...
            reached by all communities in the world. I think it's one of the
            best things to do in this little world, which motivates me.
          </p>
          <p className="about-paragraph">
            You can see my main profiles below;
          </p>
          <div className="about-profiles">
            <p className="about-tags">Social&nbsp; <FaArrowCircleDown/></p>
            <div className="about-social">
              ...
              <a href="https://steamcommunity.com/profiles/76561198274152093/"
                 target="_blank" rel="noreferrer" className="about-social-link">
                <FaSteam/>&nbsp;Steam
              </a>
              <a href="https://open.spotify.com/user/eeo4uni1zcvrjfkz4vkjskuaw?si=14f7ab112c184abc"
                 target="_blank" rel="noreferrer" className="about-social-link">
                <FaSpotify/>&nbsp;Spotify
              </a>
            </div>
